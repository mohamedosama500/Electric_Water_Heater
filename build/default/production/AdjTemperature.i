...
# 11 "AdjTemperature.c" 2

# 1 "./adc.h" 1
# 38 "./adc.h"
void ADC_iinit(void);
int ADC_Reead(char Channel);
# 12 "AdjTemperature.c" 2
...
# 16 "AdjTemperature.c" 2

# 1 "./CTR.h" 1
# 35 "./CTR.h"
void CTR_Init(void);
void CTR_Update(char condition);
# 17 "AdjTemperature.c" 2

# 1 "./HELLED.h" 1
# 36 "./HELLED.h"
void HELLED_Init(void);
void HELED_Update(char status);
# 18 "AdjTemperature.c" 2

# 1 "./AdjTemperature.h" 1
# 35 "./AdjTemperature.h"
void Temp_Init(void);
void Temp_Reading(void);
void temp_Update(void);
# 19 "AdjTemperature.c" 2
